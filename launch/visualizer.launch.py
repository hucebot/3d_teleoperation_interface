...
def generate_nodes(config_file):
    ...
    rgb_image_width = config_file['3d_viewer']['rgb_image_width']
    rgb_image_height = config_file['3d_viewer']['rgb_image_height']
    ...
    camera_image_topic = config_file['3d_viewer']['camera_image_topic']
